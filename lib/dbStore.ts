...
function toStory(row: any): Story {
  ...
  const sources: SourceArticle[] = (row.sources || []).map((s: any) => ({
    ...
    websiteUrl: s.outlet?.websiteUrl || undefined,
    country: s.outlet?.country || undefined,
    foundedYear: typeof s.outlet?.foundedYear === "number" ? s.outlet.foundedYear : undefined,
    description: s.outlet?.description || undefined,
    groundNewsSourceId: s.outlet?.groundNewsSourceId || undefined,
    groundNewsSourceSlug: s.outlet?.groundNewsSourceSlug || undefined,
    outletProfileUrl: s.outlet?.groundNewsUrl || undefined,
    groundNewsUrl: s.outlet?.groundNewsUrl || undefined,
